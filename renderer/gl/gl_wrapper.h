...
void GlArrayBufferStaticData(const char* data, u32 size);
void GlArrayBufferDynamicData(const char* data, u32 size);

void GlIndexArrayBufferBind(u32 id);
void GlIndexBufferUnbind();
void GlIndexArrayBufferStaticData(const char* data, u32 size);
void GlIndexArrayBufferDynamicData(const char* data, u32 size);
...
inline void GlArrayBufferStaticData(const char* data, u32 size) {
	glBufferData(GL_ARRAY_BUFFER, size, data, GL_STATIC_DRAW);
	GLAssert();
}

inline void GlArrayBufferDynamicData(const char* data, u32 size) {
...
inline void GlIndexArrayBufferStaticData(const char* data, u32 size) {
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, size, data, GL_STATIC_DRAW);
	GLAssert();
}

inline void GlIndexArrayBufferDynamicData(const char* data, u32 size) {
